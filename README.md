...
Open `index.html` in a browser, or serve the directory with a static HTTP server.

## Website pages

| Page | Purpose |
|---|---|
| `index.html` | Home page, core product overview, calculator, credit process, FAQs, and application modal. |
| `financing.html` | Complete financing hub linking all seven product pathways. |
| `businesses.html` | Business-facing pathways for working capital, invoice, import, asset, merchant, and order-fulfilment finance. |
| `merchant-finance.html` | Merchant Finance and POS Finance, positioned as expanding, transaction-led products. |
...
| `contact.html` | Financing-request form with all business, merchant, personal, and student product choices. |

## Included product pathways
